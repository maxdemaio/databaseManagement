...
-------------------- Resource --------------------------------
CREATE TABLE ResourceLangs (
	resourceId INTEGER not null AUTO_INCREMENT,
	lang varchar(30) not null,
    descrip varchar(500),
    CONSTRAINT ResourcePk PRIMARY KEY (ResourceId)
);
...
CREATE TABLE Enrollment (
	...
	CONSTRAINT OfferingFK FOREIGN KEY (OfferNo) REFERENCES Offering (OfferNo) ON DELETE CASCADE,
