...
INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 ...
	 VALUES ('543-21-0987','VICTORIA','EMMANUEL','BOTHELL','WA','MS','PROF',120000.0,'','2005-04-15','98011-2242');

INSERT INTO faculty
	(FacNo, FacFirstName, FacLastName, FacCity, FacState,
	 FacDept, FacRank, FacSalary, FacSupervisor, FacHireDate, FacZipCode)
	 VALUES ('765-43-2109','NICKI','MACON','BELLEVUE','WA','FIN','PROF',65000.00,'','2006-04-11','98015-9945');
